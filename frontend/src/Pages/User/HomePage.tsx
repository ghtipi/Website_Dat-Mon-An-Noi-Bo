...
const HomePage = () => {
  return (
    <Layout>
      <div className="flex flex-col lg:flex-row gap-8 px-4 sm:px-6 lg:px-8 py-8">
        {/* Main Content - Chiếm 80% trên desktop, full width trên mobile */}
        <div className="w-full lg:w-4/5 space-y-12">
          ...
          <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Card Menu */}
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden transform transition hover:-translate-y-1 hover:shadow-xl">
              <div className="p-6">
                ...
                <h3 className="text-xl font-semibold mb-2">Xem Menu</h3>
                <p className="text-gray-600 mb-4">Khám phá menu đa dạng với nhiều món ăn ngon.</p>
                <Link
                  to="/menu"
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden transform transition hover:-translate-y-1 hover:shadow-xl">
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">Đặt món ăn yêu thích nhanh chóng và dễ dàng.</p>
                <Link
                  to="/order"
                  className="inline-flex items-center text-teal-600 hover:text-teal-800 font-medium"
                >
          ...
          {/* Contact Section */}
          <section className="mt-12 bg-gradient-to-r from-teal-600 to-teal-500 rounded-2xl shadow-lg overflow-hidden">
            <div className="p-8 text-white">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  ...
                  <p className="text-teal-100">123 Đường ABC, Quận XYZ, TP. HCM</p>
                </div>
                <div>
                  <h3 className="text-xl font-semibold mb-4 flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <p className="text-teal-100">Email: contact@example.com</p>
                  <p className="text-teal-100">Điện thoại: (012) 345-6789</p>
                </div>
              </div>
            </div>
          </section>
        ...
        {/* Sidebar - Chiếm 20% trên desktop, ẩn trên mobile hoặc có thể thêm toggle */}
        <div className="w-full lg:w-1/5 space-y-6">
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
            ...
            <div className="p-4">
              <h3 className="font-semibold mb-2">Giảm 20% cho đơn đầu tiên</h3>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-4">
            <h3 className="font-semibold text-lg mb-3 pb-2 border-b">Món Phổ Biến</h3>
            <div className="space-y-3">
              {[1, 2, 3, 4].map((item) => (
                <div key={item} className="flex items-center space-x-3">
                  ...
                  <div>
                    <h4 className="font-medium text-sm">Tên món ăn {item}</h4>
          ...
          {/* Newsletter */}
          <div className="bg-white rounded-2xl shadow-lg p-4">
            <h3 className="font-semibold text-lg mb-3">Nhận Ưu Đãi</h3>
